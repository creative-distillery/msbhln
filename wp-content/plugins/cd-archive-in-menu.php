<?php
  ...
  Plugin URI: https://creativedistillery.com
  Description: Adds a new metabox item to WordPress's menu builder. Allows quick access to add custom post types archive pages instead of having to rely on custom links.
  Version: 1.0
