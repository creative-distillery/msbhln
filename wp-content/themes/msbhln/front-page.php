      ...
      <div class="col-12 col-md-4">
        <div class="event">
          ...
          <div class="d-flex justify-content-between">
            <a class="cd-btn" href="<?php the_permalink(); ?>">More Info <i class="fa fa-chevron-right"></i></a>
            <a class="cd-btn" href="<?php the_field( 'registration_link' ); ?>">Register Now  <i class="fa fa-chevron-right"></i></a>
          </div>
        </div>
      </div>
